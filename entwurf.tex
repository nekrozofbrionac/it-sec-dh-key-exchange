    ...
    \author{\IEEEauthorblockN{Chingun Ariunbat\\ (arch1012)}
    	\and
    	\IEEEauthorblockN{Kian Farhadi\\ (faki1011)}
    	\and
    	\IEEEauthorblockN{Leonie Thiessen\\ (thmi1016)}
    	\and
    	\IEEEauthorblockN{Svenja Wagenseil\\ (wasv1013)}
    }
